...
namespace EjercicioVideoJuego
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (eleccion != "6")
            {
                ...
                switch (eleccion)
                {
                    ...
                    case "4":
                        ...
                        for (int i = 0; i < HistorialDeCombates.ListaDeCombates.Count; i++)
                        {

                            Console.WriteLine($"Combate N°{i + 1}: {HistorialDeCombates.ListaDeCombates[i].Personaje1.Tipo} {HistorialDeCombates.ListaDeCombates[i].Personaje1.Nombre} VS {HistorialDeCombates.ListaDeCombates[i].Personaje2.Tipo} {HistorialDeCombates.ListaDeCombates[i].Personaje2.Nombre}; Ganador: {HistorialDeCombates.ListaDeCombates[i].Ganador.Tipo} {HistorialDeCombates.ListaDeCombates[i].Ganador.Nombre}");
                    ...
                    case "5":
                        Console.WriteLine("Personaje - Cantidad de combates jugados - Cantidad de victorias - Cantidad de derrotas - Daño total infligido - Daño recibido");
                        for (int i = 0; i < ControlDePersonajes.ListaPersonajes.Count; i++)
                        {

                            Console.WriteLine($"{ControlDePersonajes.ListaPersonajes[i].Tipo} {ControlDePersonajes.ListaPersonajes[i].Nombre} - {ControlDePersonajes.ListaPersonajes[i].CantidadDeCombates} - {ControlDePersonajes.ListaPersonajes[i].CantVictorias} - {ControlDePersonajes.ListaPersonajes[i].CantDerrotas} - {ControlDePersonajes.ListaPersonajes[i].DañoTotalInflingido} - {ControlDePersonajes.ListaPersonajes[i].DañoRecibido}");
            ...
            Console.WriteLine("Usted salio del videojuego.");
